...
import {ISidebarItemProps} from "@/components/shared/sidebar/SidebarItem";
import {authOptions} from "@/app/api/auth/[...nextauth]/route";
import {LogoutButton, SidebarItem} from "@/components/shared";
...
const menuItem = [
  ...
  {
    icon: <IoPersonOutline></IoPersonOutline>,
    title: "Profile",
